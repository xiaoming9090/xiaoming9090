...
| ----------------------- | ------------------------------------------------------------ | --------- | ---- |
| Bond Protocol Update #1 | Enables the creation of Olympus-style bond markets for any token pair | Sherlock  | 3rd  |
| Notional Update #2      | Protocol that facilitates fixed-rate, fixed-term crypto asset lending and borrowing | Sherlock  | 1st  |
| Optimism                | Optimism is a low-cost and lightning-fast Ethereum L2 blockchain. | Sherlock  | 24th |
| ParaSpace               | Cross-margin NFT financialization protocol.                  | Code4rena | 12th |
| Notional Update #1      | Protocol that facilitates fixed-rate, fixed-term crypto asset lending and borrowing | Sherlock  | 1st  |
...
| Putty Finance           | Order-book based options market for NFTs and ERC20s.         | Code4rena | 6th  |
| Aura Finance            | Provide maximum incentives to Balancer liquidity providers and BAL stakers | Code4rena | 15th |
| Rubicon                 | On-chain order book protocol for Ethereum, built on L2s.     | Code4rena | 7th  |
| Notional x Index Coop   | Collaboration between Notional and Index Coop to create fixed-rate yield index tokens. | Code4rena | 3rd  |
