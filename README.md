...
I'm a Founding Security Researcher at [@blackthornxyz](https://x.com/blackthornxyz), Lead Senior Watson at [@sherlockdefi](https://x.com/sherlockdefi), and Security Researcher at [@SpearbitDAO](https://x.com/SpearbitDAO), specializing in smart contract audits with a proven track record in public audit contests (with 38 top-three finishings) and extensive experience auditing complex and high-profile protocols.
...
For private audits or security consulting, please contact me on Twitter ([@xiaoming90](https://twitter.com/xiaoming90)) or Discord ([xiaoming90](https://discord.com/users/xiaoming90)).

### Highlights

- Ranked in the top 3 in 38 audit contests at Code4rena and Sherlock
...
- TheDAO's ETHSecurity Badge holder, which represents Ethereum's top security experts [[2]](https://x.com/thedaofund/status/2046971022897819900)

### Private Engagements

| Project              | Description                                                  | Platform |
| -------------------- | ------------------------------------------------------------ | -------- |
| AAVE V4 | Decentralised non-custodial liquidity protocol where users can participate as suppliers or borrowers. | Blackthorn |
| Morpho Midnight | A non-custodial, intent-based protocol built for fixed-rate, fixed-term lending | Blackthorn |
...
| Tenor | Tenor provides an interface to the Morpho protocol, a non-custodial, self-executing onchain protocol that matches lenders and borrowers at fixed interest rates | Blackthorn |
| Aero | Unified liquidity layer for Ethereum | Blackthorn |
| Usual Money | Stablecoin issuer that redistributes ownership and governance through the $USUAL token and a multi-chain infrastructure that aggregates the tokenized Real-World Assets (RWAs) from entities | Blackthorn |
| Fira Protocol | Fira is a fixed-rate lending and borrowing protocol. It introduces maturity-based credit as a native onchain primitive | Blackthorn |
| Rain | Stablecoin payments platform for enterprise | Blackthorn |
| M^ZERO               | Neutral value transmission framework able to permissionlessly mint currencies under decentralized governance. | Blackthorn |
| Curvance | Lending protocol that offers a new solution to the challenge of capital efficiency and composability in DeFi | Blackthorn |
| Perennial V3 | Protocol that enables the capital-efficient and seamless perps trading experience | Blackthorn |
| Lombard Finance | Protocol that allows BTC holders, institutions, and developers to put BTC to work onchain | Blackthorn |
...
| Byzantine Finance | An institutional-grade digital credit product | Blackthorn |
| Icarus Finance | Central trading and liquidity hub on RISE | Blackthorn |
| Byzanlink | Protocol that enabling financial institutions to tokenise, manage, and operate assets onchain. | Blackthorn |
...
| Nostra Finance | Protocol that allows users to lend, borrow, swap and bridge cryptocurrencies. | Spearbit |
...
| ------------------------------------ | ------------------------------------------------------------ | :-----------------------------------------: | :-------: |
| Fluid V2 | Liquidity protocol that combines a lending protocol and a DEX | 🥇1 /1009 | Sherlock |
